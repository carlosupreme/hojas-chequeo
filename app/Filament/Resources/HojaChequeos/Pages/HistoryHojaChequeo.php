...
class HistoryHojaChequeo extends Page
{
    ...
    protected string $view = 'filament.resources.hoja-chequeo-resource.pages.history-hoja-chequeo';
    ...
    public function exportExcel()
    {
        try {
            ...
            foreach ($headers as $header) {
                $col++;
                $cellCoordinate = Coordinate::stringFromColumnIndex($col) . $tableStartRow;
