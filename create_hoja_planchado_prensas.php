...
$equipos = [
    ['tag' => 'PL-PRN-02',  'nombre' => 'PRENSA 2'],
    ['tag' => 'PL-PRN-05',  'nombre' => 'PRENSA 5'],
    ['tag' => 'PL-PRN-14',  'nombre' => 'PRENSA 14'],
    ['tag' => 'PL-PRN-03',  'nombre' => 'PRENSA 3'],
    ['tag' => 'PL02-PRN-03', 'nombre' => 'PRENSA 2-3'],
    ['tag' => 'PL-PRN-07',  'nombre' => 'PRENSA 7'],
    ['tag' => 'PL02-PRN-02', 'nombre' => 'PRENSA 2-2'],
    ['tag' => 'PL02-PRN-03', 'nombre' => 'PRENSA 2-3'],
    ['tag' => 'PL-PRN-08',  'nombre' => 'PRENSA 8'],
];

foreach ($equipos as $equipoData) {
    DB::transaction(function () use ($equipoData) {
        $equipo = Equipo::firstOrCreate(
            ['tag' => $equipoData['tag']],
            ['nombre' => $equipoData['nombre'], 'area' => 'PLANCHADO']
        );

        $version = HojaChequeo::getCurrentVersion($equipo->id);
        ...
        echo "Equipo {$equipoData['tag']} (ID: {$equipo->id}) → HojaChequeo ID: {$hoja->id}, version: {$hoja->version}\n";
    });
}
