    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            <div class="flex items-center gap-4">
                <img
                    :src="theme === 'dark' || (theme === 'system' && window.matchMedia('(prefers-color-scheme: dark)').matches) ? '/dark.png' : '/logo.png'"
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="relative" @click.away="themeMenuOpen = false">
                    <button @click="themeMenuOpen = !themeMenuOpen"
                        ...
                        <svg x-show="theme === 'system'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                             viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div x-show="themeMenuOpen"
                        ...
                        <div class="py-1">
                            <button @click="theme = 'light'; themeMenuOpen = false"
                                ...
                                <svg
                                    class="mr-3 h-5 w-5 text-[var(--text-muted)] group-hover:text-[var(--text-primary)]"
